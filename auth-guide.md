# Гайд по авторизации: от теории к диаграммам

Этот гайд поможет понять ключевые концепции современной аутентификации и авторизации, а также научиться визуализировать эти процессы с помощью UML sequence-диаграмм.

## 1. Ключевые концепции авторизации
...
## 2. Как отображать HTTP и SQL в sequence-диаграммах
...
## 3. Таблица HTTP-статусов для авторизации
