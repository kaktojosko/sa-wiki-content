...
*   **   **Безопасность:** Да.*   *   **Идемпотентность:** Да.
...
*   **   **Безопасность:** Нет.*   **   **Идемпотентность:** Нет.*   **Тело запроса**: Есть.
...
*   **Безопасность**: Нет.
*   **Идемпотентность**: Да.
*   **   **Тело запроса:** Может быть, но обычно не используется.*   *   **Кеширование:** Нет.
