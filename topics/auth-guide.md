...
> Если нужно быстро развести термины, см. [auth-vs-auth](https://sawiki.ru/topic/auth-vs-auth).
...
| :--- | :--- | :--- |
| Создание пользователя | `INSERT INTO users (...) <br>
VALUES (...)` | Регистрация. |
...
| Сохранение refresh token | `INSERT INTO refresh_tokens (...) <br>
VALUES (...)` | Создание «длинной» сессии/устройства. |
| Ротация refresh token | `UPDATE refresh_tokens <br>
SET token_hash = ?, <br>rotated_at = ? <br>WHERE id = ?` | Снижение риска при компрометации. |
| Отзыв токенов | `DELETE FROM refresh_tokens <br>
