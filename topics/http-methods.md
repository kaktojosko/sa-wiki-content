...
| Метод  | Описание                                     | Идемпотентный | Безопасный | Пример использования                               |
| :----- | :------------------------------------------- | :------------ | :--------- | :------------------------------------------------- |
| GET    | Получение ресурса                           | Да            | Да         | Получение списка пользователей: `GET /users`       |
| POST   | Создание нового ресурса                      | Нет           | Нет        | Создание нового пользователя: `POST /users`        |
| PUT    | Полное обновление/замена ресурса             | Да            | Нет        | Обновление данных пользователя: `PUT /users/123`   |
| PATCH  | Частичное обновление ресурса                 | Нет           | Нет        | Обновление имени пользователя: `PATCH /users/123`  |
| DELETE | Удаление ресурса                             | Да            | Нет        | Удаление пользователя: `DELETE /users/123`         |
_
