...
LLM уже стали рабочим инструментом аналитика, но главный эффект не в скорости написания текста, а в том, что LLM позволяет повысить качество артефактов. Хороший аналитик использует LLM не как "автогенератор требований", а как генератор идей и помощника в проверке полноты, непротиворечивости и тестируемости.
