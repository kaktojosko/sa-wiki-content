...
5. **Неправильное использование активации объектов.** Если объект активируется, он должен быть деактивирован. Если объект деактивируется, он не должен быть активирован.
